...
describe('Degree API:', function() {
  ...
  describe('GET /api/degrees', function() {
    ...
    it('should respond with JSON array', function() {
      expect(degrees).to.be.instanceOf(Array);
    });
  ...
  describe('POST /api/degrees', function() {
    ...
    it('should respond with the newly created degree', function() {
      expect(newDegree.name).to.equal('New Degree');
      expect(newDegree.info).to.equal('This is the brand new degree!!!');
    });
  ...
  describe('GET /api/degrees/:id', function() {
    ...
    it('should respond with the requested degree', function() {
      expect(degree.name).to.equal('New Degree');
      expect(degree.info).to.equal('This is the brand new degree!!!');
    });
  ...
  describe('PUT /api/degrees/:id', function() {
    ...
    it('should respond with the updated degree', function() {
      expect(updatedDegree.name).to.equal('Updated Degree');
      expect(updatedDegree.info).to.equal('This is the updated degree!!!');
    });
